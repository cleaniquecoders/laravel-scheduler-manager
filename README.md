# Manage scheduler from config and GUI
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-scheduler-manager.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-scheduler-manager)
...
```bash
php artisan vendor:publish --tag="laravel-scheduler-manager-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-scheduler-manager-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-scheduler-manager-views"
```

## Usage

```php
$laravelSchedulerManager = new CleaniqueCoders\LaravelSchedulerManager();
echo $laravelSchedulerManager->echoPhrase('Hello, CleaniqueCoders!');
```
